...
def train_target(args):
    ...
    print(f'model loaded from {args.output_dir_src}')
    ...
    while iter_num < max_iter:
        ...
        wandb.log({'train_classifier_loss': classifier_loss.item()})
...
def train_target_cycle(args, netF, netB, netC):
    print(args)
    print("Started Cyclic training ")
...
if __name__ == "__main__":
    ...
    for i in range(len(names)):
        ...
        args.t_dset_path = 'data/office-home/Clipart.txt'#'data/office_home_mixed/Clipart_Product_Real_World.txt'
        args.test_dset_path = 'data/office-home/Clipart.txt'#'data/office_home_mixed/Clipart_Product_Real_World.txt'
        wandb.init(project='vit_da', entity='vclab', name=f'Adaptation {names[args.s]}', mode='disabled')

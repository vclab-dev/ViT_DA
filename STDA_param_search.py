...
if __name__ == "__main__":
    ...
    parser.add_argument('--const_par', type=float, default=1.0)
    ...
    parser.add_argument('--output', type=str, default='param_search_STDA', help='Save ur weights here')

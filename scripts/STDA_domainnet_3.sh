...
python3 STDA_fbnm.py --gpu_id '2,0,1' --s 1 --t 0 2 3 4 5 --max_epoch 5 --interval 5 --batch_size 56 --dset domain_net --net vit --wandb 1 --fbnm_par 4.0 --output_src src_train --output weights/STDA_wt_fbnm_rlccsoft --suffix fbnm_rlcc_soft --rlcc 1 --soft_pl 1

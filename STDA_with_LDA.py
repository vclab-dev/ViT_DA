...
def train_target(args):
    ...
    while iter_num < max_iter:
        ...
        if args.lda and iter_num > int(0.8*max_iter):
...
if __name__ == "__main__":
    ...
    for i in range(len(names)):
        ...
        import wandb
        wandb.init(project='Dual Clustering', entity='vclab', name=f'{names[args.s]} to {names[args.t]} with LDA loss(std - mu)', reinit=True,mode=mode)

...
from data_list_Office import ImageList, ImageList_idx
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dset', type=str, default='office-home',
                        choices=['VISDA-C', 'office', 'office-home', 'office-caltech', 'pacs'])
    ...
    for i in range(len(names)):
        ...
        args.test_dset_path = folder + args.dset + '/' + 'domain_net_label' + '/' + names[args.t] + '_test.txt'
        args.t_dset_path = folder + args.dset + '/' + 'domain_net_label' + '/' + names[args.t] + '_test.txt'
        ...
        import wandb
        wandb.init(project='BMVC_vit_pacs', entity='vclab', name=f'Im+pseudo CE {names[args.s]} to {names[args.t]}', reinit=True)

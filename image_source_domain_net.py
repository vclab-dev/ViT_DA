...
from data_list_DomainNet import ImageList, ImageList_idx
...
if __name__ == "__main__":
    ...
    for i in range(len(names)):
        ...
        args.t_dset_path = folder + args.dset + '/' + 'domain_net_label' + '/' + names[args.t] + '_train.txt'
        

        mode = 'online' if args.wandb else 'disabled'
        
        import wandb
        wandb.init(project='DomainNet_vit_STDA', entity='vclab', name=f'{names[args.s]} to {names[args.t]} STDA', reinit=True,mode=mode)

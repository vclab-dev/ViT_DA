...
from data_list import ImageList_idx, ImageList, ImageList_MixUp, ImageList_ocda
...
def data_load(args):
    ...
    if args.dset =='domain_net':
        ...
        dset_loaders["test"] = DataLoader(dsets["test"], batch_size=args.batch_size*10, shuffle=True, drop_last=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--suffix', default=' ', type=str, help='wandb name of run')
